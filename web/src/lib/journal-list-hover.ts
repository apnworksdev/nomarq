...
const ITEM_SELECTOR = '[data-journal-list-item]';
const TITLE_SELECTOR = '[data-journal-list-title]';
const DESCRIPTION_SELECTOR = '[data-journal-list-description]';
...
export function initJournalListHover() {
...
export function initJournalListHoverState() {
  let cleanup: (() => void) | undefined;

  const run = () => {
    cleanup?.();
    cleanup = initJournalListHover();
  };
